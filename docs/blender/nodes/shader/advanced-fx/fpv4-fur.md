---
title: "FPv4 Fur"
description: "The FPv4 Fur node group from Fortnite Porting."
---

# FPv4 Fur

<!-- TODO: replace this intro with a short description of what the node does. -->
The FPv4 Fur node group from Fortnite Porting.

<!-- Add a node screenshot at docs/public/blender/nodes/shader/advanced-fx/fpv4-fur.png then uncomment:
![FPv4 Fur](/blender/nodes/shader/advanced-fx/fpv4-fur.png)
-->
