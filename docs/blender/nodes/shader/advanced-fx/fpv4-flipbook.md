---
title: "FPv4 Flipbook"
description: "The FPv4 Flipbook node group from Fortnite Porting."
---

# FPv4 Flipbook

<!-- TODO: replace this intro with a short description of what the node does. -->
The FPv4 Flipbook node group from Fortnite Porting.

<!-- Add a node screenshot at docs/public/blender/nodes/shader/advanced-fx/fpv4-flipbook.png then uncomment:
![FPv4 Flipbook](/blender/nodes/shader/advanced-fx/fpv4-flipbook.png)
-->
